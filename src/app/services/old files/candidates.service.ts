...
export class CandidateService {
  ...
  */
  ...
  //
  //   return this.http.get<any>(url).pipe(
  //     tap(response => { // Use tap to log the response without affecting the stream
  //       console.log("Raw HTTP Response:", response); // Log the raw response
  //       console.log("Response as JSON string:", JSON.stringify(response)); // Log as stringified JSON
  //     }),
  //     map(response => {
  //       if (!response) {
  ...
  //       console.log("Mapped Interview:", mappedInterview); // Log the mapped object
